...
if(isset($_POST['update_product'])){
   ...
   mysqli_query($conn, "UPDATE `products` SET name = '$name',categories='$categories', details = '$details', price = '$price' WHERE id = '$update_p_id'") or die('query failed');
...
<form action="" method="post" enctype="multipart/form-data">
   ...
   <input type="text" class="box" value="<?php echo $fetch_products['categories']; ?>" required placeholder="update occasion" name="categories">
   ...
   <a href="admin_viewproducts.php" class="option-btn">go back</a>
</form>
