...
<head>
   ...
   <style>
    .checkout{
        background-image:url(images/flower_shop-bg1.jpg);
    }
...
<section class="checkout">
    ...
    <form action="" method="POST">
        ...
        <div class="flex">
            ...
            <div class="inputBox">
                <span>ward no :</span>
                <input type="text" name="flat" placeholder="e.g. ward-23">
            </div>
            <div class="inputBox">
                <span>street:</span>
                <input type="text" name="street" placeholder="e.g.  ">
            </div>
            <div class="inputBox">
                <span>city :</span>
            ...
            <div class="inputBox">
                <span>province no:</span>
                <input type="text" name="state" placeholder="e.g. 04 ">
            </div>
            <div class="inputBox">
                <span> country:</span>
